...
public class ManejadorGlobalExcepciones {
        ...
        @ExceptionHandler(ServicioCorreoException.class)
        public ResponseEntity<ErrorRespuesta> manejarServicioCorreo(
                        ServicioCorreoException ex, HttpServletRequest request) {
        ...
        @ExceptionHandler(ServicioWhatsappException.class)
        public ResponseEntity<ErrorRespuesta> manejarServicioWhatsapp(
                        ServicioWhatsappException ex, HttpServletRequest request) {
