...
public class  AutenticacionServicio{
    ...
    //Este se ecarga de verificar el correo la contraseña del ususario consultando la BD
    private final AuthenticationManager authenticationManager;
    
    //este genera y valida en token JWT
    private final JwtProveedor jwtProveedor;

    //acceso a la tabla de usuarios en la BD
    private final UsuarioRepository usuarioRepository;
    

    //Encripta las contraseñas para guardarlas de forma segura en la BD
    ...
    //Verifica si la cuenta esta bloqueada por intentos fallidos si esta bloqueada 403
    //Intenta autenticar con Spring Security:
    // si es exito resetear intentos fallidos y generar token JWT
    // si es fallo incrementar intentos fallidos y bloquear cuenta si se supera el maximo de intentos
        ...
        Usuario usuario = usuarioRepository.findByCorreoElectronico(
            ...
            .orElseThrow(() -> new RecursoNoEncontradoException(
                ...
                */
                ...
                El rol siempre sera de USUARIO_ESTANDARD para cambiar el rol un admin lo tiene que hacer 
                */
                ...
                public void registrar(RegistroDTO registroDTO){
                     ...
                     if (registroDTO.getCorreoElectronico() != null
                        ...
                        //construir la  entidad de usuario 
                        ...
                        Usuario nuevoUsuario =  Usuario.builder()
                            ...
                            .contrasenaHash(passwordEncoder.encode(registroDTO.getContrasena()))//encriptar la contraseña
                            .rol(co.edu.sena.sigea.common.enums.Rol.USUARIO_ESTANDAR)
                            .esSuperAdmin(false) //por defecto no es super admin
                            .intentosFallidos(0) //iniciar con 0 intentos fallidos
