-- ============================================================================
-- Crear/actualizar usuario ALIMENTADOR_EQUIPOS en SIGEA (idempotente).
-- ============================================================================
...
--   correo: alimentacion@sigea.local
--   contraseña: password
-- ============================================================================
...
INSERT INTO usuario (
    ...
    'Usuario Alimentacion SIGEA',
    'CC',
    '777777777',
    'alimentacion@sigea.local',
    NULL,
    NULL,
    NULL,
...
-- FROM usuario WHERE correo_electronico = 'alimentacion@sigea.local';-- ============================================================
